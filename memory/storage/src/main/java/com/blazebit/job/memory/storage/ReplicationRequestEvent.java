...
public class ReplicationRequestEvent implements StateReturningEvent<InitialReplicationData> {
    ...
    @Override
    public InitialReplicationData getResult() {
        return initialReplicationData;
    }

    /**
     * Sets the initial replication data.
     *
     * @param initialReplicationData The initial replication data
     */
