...
/**
 * A JTA-based implementation for {@link TransactionSupport}.
 *
...
public class JtaTransactionSupport implements TransactionSupport {
    ...
    /**
     * Create a new transaction support using the default JTA resources from known JNDI names.
     */
    ...
    /**
     * Create a JTA transaction support using the given {@link TransactionManager} which is supposed to also implement the {@link TransactionSynchronizationRegistry} interface.
     *
    ...
    /**
     * Creates a new JTA transaction support.
     *
     * @param tm  The transaction manager
